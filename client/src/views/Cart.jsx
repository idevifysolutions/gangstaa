...
const Cart = () => {
  ...
  return (
    <div className='py-8 px-16 flex flex-wrap justify-center gap-[4rem] "h-[calc(100vh-4rem)]"'>
      ...
      <aside className="w-[80%] md:w-[30%] lg:w-[30%] h-[70%] p-4 md:p-8 lg:p-16 flex flex-col justify-center items-stretch gap-[1rem] md:gap-[1.3rem] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
