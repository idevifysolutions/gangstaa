        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row items-center mb-4 md:mb-0 gap-2 md:gap-8 ">
            ...
            <div className="flex flex-col text-center">
              <span className="uppercase text-semibold text-[12px] sm:text-[16px] md:text-lg lg:text-lg xl:text-lg 2xl:text-lg">
                Shipping on the House
              </span>
              <span className="text-[11px]  sm:text-[11px] md:text-sm lg:text-sm xl:text-sm 2xl:text-sm text-slate-900">
                For orders over 749/-
              </span>
            </div>
          </div>
