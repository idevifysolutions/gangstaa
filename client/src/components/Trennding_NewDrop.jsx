  ...
  return (
    <>
      <div className=" w-full sm:w-[100vw] sm:mx-auto">
        <div className="w-fit h-fit md:w-fit md:h-fit   mx-auto my-5  mb-14 flex gap-5 ">
          <div className="newdrops" onClick={handleNewDropClick}>
            <button className="bg-white border-[1px] border-black rounded-xl px-2 py-1 uppercase">
              New Drops
            </button>
          </div>

          <div className="mosttending " onClick={handleTrendingClick}>
            <button className="uppercase bg-white border-[1px] border-black rounded-xl px-2 py-1">
              Most Trending
            </button>
          </div>
        </div>
          ...
          <div className="  w-[96%] h-[550px] lg:w-[90%] lg:h-fit  lg:gap-4  xl:w-[95%] xl:h-[69vh]  xl:gap-5 md:gap-2 md:w-[98%] w-90%    mx-auto  flex lg:flex md:flex gap-5 md:overflow-hidden  overflow-x-scroll hide-scrollbar">
            {newDropProducts.map((product, index) => {
              return (
                ...
                <div className="  h-[400px] w-[500px] md:h-[400px] md:w-[50%] lg:w-[40%] lg:h-[500px]  xl:w-[20%] xl:h-full bg-slate-100 " key={index} >
                  <div
        ...
        <div className=" w-fit h-fit  mx-auto my-10  mb-14 flex gap-5">
          <div className="newdrops ">
            <button className="uppercase bg-white border-[1px] border-slate-200 text-[12px] px-2 py-2 tracking-[3px] hover:border-black transition duration-500 ease-in hover:scale-125">
              View all
            </button>
          </div>
        </div>
